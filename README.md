...
本项目旨在为个人提供客观、严谨且富有趣味性的对话沟通诊断与亲密关系评估服务。用户只需输入双方的角色关系（如：相亲对象，男生A与女生B）与一整段真实的聊天对话历史记录，AI 即可根据交往心理学自动输出潜台词精细破译、话权平衡硬核诊断、推进关系破局指南及每日雷达探测打卡金句。页面内置了支持物理发音的互动“情感雷达探测”印章，帮助用户精准破译对话意图并快速完成沟通破局落地。
