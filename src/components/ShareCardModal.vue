    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">聊天记录与关系分析</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 聊天记录透视与关系情感诊断</span>
...
// 清理回复末尾的特殊标记 [LTJL_SCORES]...[/LTJL_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[LTJL_SCORES\][\s\S]*?\[\/LTJL_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 聊天记录与关系分析】\n\n${cleanContent.value}\n\n体验科学聊天记录分析与情感诊断：https://ai.wuxian.xyz`;
